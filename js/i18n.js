const messages = {
    zh: {
        ...
        restart: '重新开始',
        introTitle: '开场任务',
        introBody: '你是一名采访记者，需要在信息不确定的情况下持续追踪山火事件，并在核实与时效之间做出取舍。',
        introNameLabel: '你的名字',
    ...
    en: {
        ...
        introBody: 'You are a field reporter covering the wildfire, working under uncertainty and balancing verification with timeliness.',
