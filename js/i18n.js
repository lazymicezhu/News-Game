const messages = {
    zh: {
        ...
        restart: '重新开始',
        introTitle: '开场任务',
        introBody: '你是一名采访记者，需要跟踪报道本次山火事件。你需要不断收集数据以增加新闻价值（满分 100 分）。',
        introNameLabel: '你的名字',
    ...
    en: {
        ...
        introBody: 'You are a field reporter covering the wildfire. Keep collecting data to increase your story value (max 100).',
        ...
        assistantGenerating: 'Generating reply...',
