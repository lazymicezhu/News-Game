const messages = {
    zh: {
        ...
        introStart: '开始报道',
        preludeLine1: '你是一位媒体工作者。',
        preludeLine2: '你在工作中坚守自己对真相的执着。',
        preludeLine3: '每一次迟疑，都可能让谣言先一步抵达。',
        preludeLine4: '你刚被派往加州山火现场，空气里全是灰烬味。',
        preludeLine5: '目标：让新闻价值达到 90 以上，拿到信任结局。高质量选择与关键线索都会提高分数。',
    ...
    en: {
        ...
        preludeLine5: 'Goal: reach Story Value 90+ to unlock the trusted ending. Strong choices and key leads both raise your score.',
